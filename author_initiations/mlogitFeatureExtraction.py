...
sampled_inits_df_filename = "sampled_inits_train_df.pickle" if not should_generate_test_data else "sampled_inits_test_df.pickle"
...
sampled_initiations_filename = "author_initiation_choices_train_all_nofuturepatient.csv"
if should_generate_test_data:
    sampled_initiations_filename = "author_initiation_choices_test_all_nofuturepatient.csv"
